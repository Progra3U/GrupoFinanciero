    ...
    <div id="wrap">
        ...
        <section id="FormUsuarios">
             <form>
                ...
                <asp:TextBox class="textBox" size="30" type="text" ID="cuentaSinpe" required runat="server"></asp:TextBox>
                <asp:Label class="label" runat="server" For="Monto">Saldo:</asp:Label>
                <asp:TextBox class="textBox" size="30" type="text" ID="Saldo" required runat="server"></asp:TextBox>
